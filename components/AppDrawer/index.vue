...
const { direction, defaultSize = '50%', shouldScaleBackground = false, defaultWidth = '', transparent = false } = defineProps<{
    ...
    <DrawerPortal>
      ...
      <DrawerContent
        ...
        class="
          ...
          data-[x=true]:w-[var(--size)]
          data-[x=true]:h-full
          data-[x=false]:h-[var(--size)]
          data-[x=false]:w-[var(--w)]
